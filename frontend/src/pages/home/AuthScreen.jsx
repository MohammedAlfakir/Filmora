  ...
  return (
    <div className="hero-bg relative">
      ...
      <header className="max-w-6xl mx-auto flex items-center justify-between py-8 px-4 pb-10">
        ...
        <Link
          to={"/login"}
          className="text-white bg-cyan-600 py-2 px-5 md:py-2 md:px-10 font-semibold rounded"
        >
          Sign In
        </Link>
      </header>
      ...
      {/* hero section */}
      <div className="flex flex-col items-center justify-center text-center px-2 py-40 pt-0 text-white h-screen max-w-6xl mx-auto">
